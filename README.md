...
- **CopyPaintMod & ChalkBoard.html**
  - **CopyPaintMod**：支持将黑板上的画作复制到本地文件并在任意黑板上粘贴。操作：对准黑板时按 `Ctrl+C` 复制当前黑板；对准目标黑板按 `Ctrl+V` 粘贴，详情参考游戏内的UI
  - **ChalkBoard.html**：是一个黑板绘图编辑器，包含游戏内同款的绘画功能，也可以配合`CopyPaintMod`实现画作数据的导入导出，支持将图片转换为画作。
